                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/register?action=creatUser">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="text" name="birth" id="form3Example2cg" class="form-control form-control-lg" />
                                    <label class="form-label" for="form3Example2cg">Your birthday</label>
                                </div>
                                <div class="form-outline mb-4">
                                    <input type="text" name="email" id="form3Example3cg" class="form-control form-control-lg" readonly="readonly" value="<c:out value='${account.email}' />"/>

                                    <label class="form-label" for="form3Example3cg">Your Email</label>
                                </div>

                                <div class="form-outline mb-4">
                                    <input  type="text" name="phoneNumber" id="form3Example4cg" class="form-control form-control-lg" />
                                    <label class="form-label" for="form3Example4cg">Your phone number</label>
                                </div>

                                <div class="form-outline mb-4">
                                    <input  type="text" name = "image" id="form3Example4cdg" class="form-control form-control-lg" />
